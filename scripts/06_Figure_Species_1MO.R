...
#
#          Figure for individual species 1MO
#
#----------------------------------------------------------#
# Generates Figure S3 in the Supplement
...
write.csv(wide_data, "C:/Users/ksam/Documents/GitHub/Herb_Accumulation/data/For_figure_wide_data.csv", row.names = FALSE)


# you can also start directly here, by loading the wide data, or skip the next line if you continue from earlier lines
wide_data <- read.csv("C:/Users/ksam/Documents/GitHub/Herb_Accumulation/data/For_figure_wide_data.csv")
...
site_colors  <- c(LAK =  "blue", TOM = "turquoise" , BUB =  "lightgoldenrod1" , KAK = "orange", DRO = "red" , EUC =  "purple")
...
# Save the table
write_csv(summary_stats, "C:/Users/ksam/Documents/GitHub/Herb_Accumulation/data/summary_stats_1MO_species.csv")
