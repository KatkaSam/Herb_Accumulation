...
#
#       Initial preparation of the data from 1MO
#
#----------------------------------------------------------#
...
#----------------------------------------------------------#
# 1. Import data M0 and prepare them as sums per twigs -----
#----------------------------------------------------------#
# 1.1 Read 1MO herbivory data for individual leaves  -----
dataset_herbivory <- read.csv("C:/Users/ksam/Documents/GitHub/Herb_Accumulation/data/HerbivoryLeavesRaw_1MO_6sites_20241010.csv")
...
write_csv(
  dataset_herbivory_sum,
  "data/output/HerbivoryTwigSum_1MO_6sites_20251010.csv")
...
dataset_herbivory_sum <- read.csv("data/HerbivoryTwigSum_1MO_6sites_20241010b.csv")
summary(dataset_herbivory_sum)
...
write_csv(
  ...
  "C:/Users/ksam/Documents/GitHub/Herb_Accumulation/data/output/HerbivorySum_1MO_6sites_20252512_wide.csv")
